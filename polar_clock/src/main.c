...
window=window_create();
  ...
  minute_display_layer=layer_create(layer_get_bounds(window_get_root_layer(window)));
  ...
  text_date_layer=text_layer_create(layer_get_bounds(window_get_root_layer(window)));
